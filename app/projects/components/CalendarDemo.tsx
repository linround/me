...
import {calendarDemo} from "@/lib/routes";
...
export function CalendarDemo() {
  ...
  return (
    ...
    <Link href={calendarDemo.slug} className={style.linkContainer} target={'_blank'}>
      <div className={clsx([style.signboard,style.outer])}>
